package com.wanpucs.openapi.network;
...
import com.wanpucs.openapi.tx.http.MySecureProtocolSocketFactory;
...
public class NetWork {
		...
		try {
			try {
				...
				if (statusCode != HttpStatus.SC_OK) {
					throw new OpenApiException(ErrorCode.NETWORK_ERROR,
							"Request ["
									+ url
									+ "] failed:"
									+ postMethod.getStatusLine()
									+ "service response status:"
									+ StringUtils.decodeUnicode(new String(
											responseBody, CONTENT_CHARSET)));
				}
			...
			throw new OpenApiException(ErrorCode.NETWORK_ERROR, "Request ["
	...
	public static String postRequestWithFile(String url,
			Map<String, String> params, HashMap<String, String> cookies,
